...
function FundedTradeTable({ trades, onEdit, onDelete }) {
  return (
        ...
        <thead>
          <tr className="bg-gray-100 text-gray-700">
            ...
            <th className="px-4 py-3 text-left">Gain (USD)</th>
             <th className="px-4 py-3 text-left">Risk (Pips)</th>  {/* new */}
          ...
          {trades.length === 0 ? (
            ...
            trades.map((trade) => (
              ...
              >
                ...
                <td className="px-4 py-3">{trade.risk_pips}</td>    {/* new */}
...
export default FundedTradeTable;
